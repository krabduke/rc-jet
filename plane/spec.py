...
MATERIAL_MAP = {
    ...
    # the lip is the outside of the aeroplane and is painted like it; only
    # the duct behind it gets the duct finish
    "intake_lip": "airframe",
...
PALETTE = {
    ...
    # Frames and ribs are machined aluminium, not birch ply. This used to be
    # (0.470, 0.372, 0.226), and it is what you see looking into the intake,
    # because former_02 stands right behind the lip. A model aeroplane is
    # built from ply and spruce; this one is not.
    "frame_alu":   ((0.478, 0.492, 0.512), 0.85, 0.34),
    "carbon":      ((0.055, 0.058, 0.064), 0.35, 0.34),
    # Integral tanks, sealed and painted inside -- not a lithium polymer
    # pack, which is the colour this was.
    "tankage":     ((0.196, 0.212, 0.206), 0.20, 0.62),
    ...
    # Stringers and longerons are extruded aluminium, not spruce.
    "extrusion":   ((0.432, 0.448, 0.472), 0.85, 0.38),
