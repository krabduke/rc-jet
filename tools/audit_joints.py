...
CIRCUITS = [
    ...
    ('core gas path: fan to compressor to combustor to turbine',
     ['engine_vanes_fan_ogv', 'engine_bypass_struts', 'engine_splitter',
      'engine_fan_frame_struts',
      'engine_casing_hpc', 'engine_diffuser', 'engine_combustor_dome']),
    ('gas path: turbine to mixer to augmentor',
     ['engine_casing_turbine', 'engine_turbine_frame_struts', 'engine_mixer',
    ...
    ('the engine hangs off the airframe',
     ['engine_mount_trunnions', 'bay_mount_links_fwd', 'mount_ring',
      'fuselage_skin']),
    ('and is located aft',
     ['engine_mount_links_rear', 'mount_rails']),
    ('engine bay cooling reaches its exit louvres',
     ['bay_cooling_inlet', 'cooling_exit_l']),
