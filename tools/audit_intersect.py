...
KNOWN = {
    ("engine_casing_bypass", "stab_pivot_l"): 310.5,   # at (361.1, -14.7, -6.9)
    ("engine_casing_bypass", "stab_pivot_r"): 310.5,   # at (361.1, 14.7, -6.9)
    ("gear_main_l", "wing_l"): 275.9,   # at (248.7, -41.4, -6.3)
    ("gear_main_r", "wing_r"): 275.9,   # at (248.7, 41.4, -6.3)
    ("engine_bypass_inner_wall", "stab_pivot_l"): 271.2,   # at (371.9, -12.9, -6.2)
    ("engine_bypass_inner_wall", "stab_pivot_r"): 271.2,   # at (371.9, 12.9, -6.2)
    ("engine_casing_augmentor", "stab_pivot_l"): 263.0,   # at (406.1, -12.7, -6.1)
    ("engine_casing_augmentor", "stab_pivot_r"): 263.0,   # at (406.1, 12.7, -6.1)
    ...
    ("engine_augmentor_liner", "stab_pivot_l"): 207.0,   # at (409.4, -11.0, -6.0)
    ("engine_augmentor_liner", "stab_pivot_r"): 207.0,   # at (409.4, 11.0, -6.0)
    ("gear_bay_main_l", "rib_l_03"): 190.8,   # at (237.5, -49.0, -2.0)
    ("gear_bay_main_r", "rib_r_03"): 190.8,   # at (237.5, 49.0, -2.0)
    ("fcs_loom_tail_l", "stab_pivot_l"): 181.5,   # at (396.2, -9.5, -19.4)
    ("fcs_loom_tail_r", "stab_pivot_r"): 181.5,   # at (396.2, 9.5, -19.4)
    ("bay_fire_loop", "stab_pivot_l"): 180.6,   # at (386.2, -9.5, -17.0)
    ("bay_fire_loop", "stab_pivot_r"): 180.6,   # at (386.2, 9.5, -17.0)
    ("bay_doors", "stab_pivot_l"): 180.5,   # at (395.4, -9.5, -22.3)
    ("bay_doors", "stab_pivot_r"): 180.5,   # at (395.4, 9.5, -22.3)
    ("engine_casing_turbine", "stab_pivot_l"): 180.5,   # at (388.2, -9.5, -11.9)
    ("engine_casing_turbine", "stab_pivot_r"): 180.5,   # at (388.2, 9.5, -11.9)
    ("mount_rails", "stab_pivot_l"): 180.4,   # at (401.8, -9.5, -11.9)
    ("mount_rails", "stab_pivot_r"): 180.4,   # at (401.8, 9.5, -11.9)
    ("bhd_tail", "stab_pivot_l"): 180.3,   # at (387.4, -9.5, -22.0)
    ("bhd_tail", "stab_pivot_r"): 180.3,   # at (387.4, 9.5, -22.0)
    ("engine_t5_harness", "stab_pivot_l"): 179.3,   # at (387.4, -9.6, -12.7)
    ("engine_t5_harness", "stab_pivot_r"): 179.3,   # at (387.4, 9.6, -12.7)
    ("stab_pivot_l", "ventral_l"): 179.3,   # at (376.9, -9.5, -18.4)
    ("stab_pivot_r", "ventral_r"): 179.3,   # at (376.9, 9.5, -18.4)
    ("engine_turbine_cooling_manifold", "stab_pivot_l"): 178.2,   # at (383.5, -9.6, -13.0)
    ("engine_turbine_cooling_manifold", "stab_pivot_r"): 178.2,   # at (383.5, 9.6, -13.0)
    ("engine_turbine_blade_outer_air_seals", "stab_pivot_l"): 175.8,   # at (383.7, -9.3, -11.7)
    ("engine_turbine_blade_outer_air_seals", "stab_pivot_r"): 175.8,   # at (383.7, 9.3, -11.7)
    ...
    ("engine_blades_lpt_s2", "stab_pivot_l"): 175.1,   # at (382.3, -9.5, -11.5)
    ("engine_blades_lpt_s2", "stab_pivot_r"): 175.1,   # at (382.3, 9.5, -11.5)
    ("engine_flange_turb_aft", "stab_pivot_l"): 172.6,   # at (388.7, -9.2, -11.5)
    ("engine_flange_turb_aft", "stab_pivot_r"): 172.6,   # at (388.7, 9.2, -11.5)
    ("engine_blades_lpt_r2", "stab_pivot_l"): 171.5,   # at (383.8, -9.2, -11.4)
    ("engine_blades_lpt_r2", "stab_pivot_r"): 171.5,   # at (383.8, 9.2, -11.4)
    ("engine_turbine_frame_struts", "stab_pivot_l"): 169.6,   # at (388.8, -9.6, -11.3)
    ("engine_turbine_frame_struts", "stab_pivot_r"): 169.6,   # at (388.8, 9.6, -11.3)
    ("engine_spraybars", "stab_pivot_l"): 168.5,   # at (397.6, -9.3, -11.3)
    ("engine_spraybars", "stab_pivot_r"): 168.5,   # at (397.6, 9.3, -11.3)
    ("former_14", "stab_pivot_r"): 166.6,   # at (400.8, 10.0, -13.1)
    ("engine_mount_links_rear", "stab_pivot_r"): 165.6,   # at (387.5, 10.0, -11.7)
    ("seam_ring_09", "stab_pivot_l"): 158.4,   # at (383.0, -8.8, -24.6)
    ("seam_ring_09", "stab_pivot_r"): 158.4,   # at (383.0, 8.8, -24.6)
    ...
    ("antennas", "panel_battery"): 131.6,   # at (262.0, -2.4, 28.3)
    ("engine_blades_lpt_r1", "stab_pivot_l"): 125.5,   # at (380.7, -9.5, -10.1)
    ("engine_blades_lpt_r1", "stab_pivot_r"): 125.5,   # at (380.7, 7.8, -11.6)
    ...
    ("engine_flameholder", "stab_pivot_l"): 105.5,   # at (400.0, -7.3, -9.4)
    ("engine_flameholder", "stab_pivot_r"): 105.5,   # at (400.0, 7.3, -9.4)
    ("engine_mixer", "stab_pivot_l"): 104.7,   # at (389.1, -7.3, -9.4)
    ("engine_mixer", "stab_pivot_r"): 104.7,   # at (389.1, 7.3, -9.4)
    ...
    ("engine_turbine_inner_flowpath", "stab_pivot_l"): 86.7,   # at (379.1, -7.2, -6.0)
    ("engine_turbine_inner_flowpath", "stab_pivot_r"): 86.7,   # at (379.1, 7.2, -6.0)
    ("engine_oil_lines", "stab_pivot_r"): 78.7,   # at (381.2, 6.4, -17.9)
    ...
    ("engine_lpt_disc_assembly", "stab_pivot_l"): 62.9,   # at (386.1, -3.8, -6.0)
    ("engine_lpt_disc_assembly", "stab_pivot_r"): 62.9,   # at (386.1, 3.8, -6.0)
    ("panel_avionics", "throttle_lever"): 62.7,   # at (115.0, -10.1, 25.9)
    ...
    ("panel_avionics", "pilot_arms"): 31.0,   # at (134.7, -10.5, 26.3)
    ...
    ("panel_avionics", "seat_rails"): 26.9,   # at (134.7, 0.0, 27.5)
    ...
    ("panel_avionics", "seat_harness"): 24.5,   # at (134.7, 0.0, 26.8)
    ("former_03", "frame_windscreen_bow"): 24.3,   # at (88.0, -8.0, 21.7)
    ("bay_doors", "panel_fuel"): 24.1,   # at (313.5, -6.4, -28.6)
    ...
    ("control_stick", "panel_avionics"): 23.4,   # at (122.1, 8.0, 27.3)
    ...
    ("console_l", "panel_avionics"): 19.3,   # at (116.1, -10.3, 25.5)
    ("console_r", "panel_avionics"): 19.3,   # at (116.1, 10.3, 25.5)
    ("panel_avionics", "pilot_torso_legs"): 19.2,   # at (134.7, 0.0, 26.8)
    ("canopy_frame", "frame_canopy_breaker_cord"): 18.6,   # at (133.2, -14.8, 22.9)
    ("canopy_windscreen_glass", "former_03"): 18.6,   # at (88.1, 7.8, 22.3)
    ("panel_avionics", "seat_back"): 18.5,   # at (134.7, 0.0, 27.5)
    ("panel_avionics", "pilot_torso"): 18.2,   # at (134.7, 0.0, 27.5)
    ...
    ("frame_canopy_breaker_cord", "panel_avionics"): 14.8,   # at (135.0, -14.2, 25.7)
    ...
    ("engine_bearing_sumps", "stab_pivot_l"): 13.6,   # at (378.6, -4.4, -6.1)
    ("engine_bearing_sumps", "stab_pivot_r"): 13.6,   # at (378.6, 4.4, -6.1)
    ("nose_strakes", "seam_ring_03"): 13.0,   # at (98.9, -28.5, 10.1)
    ("antennas", "panel_avionics"): 12.9,   # at (262.0, 2.4, 28.3)
    ...
    ("panel_avionics", "pilot_mask"): 12.2,   # at (134.1, 3.9, 27.1)
    ("canopy_glass", "frame_canopy_seal"): 12.0,   # at (166.5, 1.9, 22.4)
    ("ejection_handle", "panel_avionics"): 12.0,   # at (126.3, 0.4, 26.8)
    ("engine_turbine_interstage_seals", "stab_pivot_l"): 11.5,   # at (377.2, -7.0, -6.6)
    ("engine_turbine_interstage_seals", "stab_pivot_r"): 11.5,   # at (377.2, 4.5, -8.5)
    ...
    ("bay_mount_links_fwd", "engine_vanes_fan_ogv"): 6.9,   # at (331.3, -12.2, 11.5)
