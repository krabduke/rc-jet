...
EXPECTED = [
    ...
    # the pilot, who is in the seat with their hands on the controls
    ("pilot_", "pilot_"),
    ("pilot_", "seat_"),
    ("pilot_", "console_"),
...
KNOWN = {
    ...
    ("gear_bay_main_r", "spar_carbon"): 132.9,   # at (250.3, 67.0, -5.9)
    ("brake_l", "wing_l"): 126.2,   # at (252.4, -44.0, -14.4)
    ("brake_r", "wing_r"): 126.2,   # at (252.4, 44.0, -14.4)
    ("gear_main_l", "wing_l"): 122.6,   # at (253.1, -46.1, -14.3)
    ("gear_main_r", "wing_r"): 122.6,   # at (253.1, 46.1, -14.3)
    ("gear_main_retract_actuator_l", "wing_l"): 121.6,   # at (255.6, -49.2, -14.1)
    ("gear_main_retract_actuator_r", "wing_r"): 121.6,   # at (255.6, 49.2, -14.1)
    ("gear_bay_nose", "longeron_3"): 111.0,   # at (29.9, -6.0, 0.2)
    ("gear_bay_nose", "longeron_4"): 111.0,   # at (29.9, 6.0, 0.2)
    ("bay_cooling_inlet", "bhd_firewall"): 108.0,   # at (299.5, -17.7, 14.8)
    ("gear_main_side_stay_l", "wing_l"): 95.5,   # at (252.6, -55.1, -13.7)
    ("gear_main_side_stay_r", "wing_r"): 95.5,   # at (252.6, 55.1, -13.7)
    ("bl_diverter", "former_03"): 91.1,   # at (88.7, 17.8, -13.0)
    ("bhd_nose", "bl_diverter"): 89.6,   # at (65.0, 9.7, -13.9)
    ("bhd_cockpit", "canopy_frame"): 87.1,   # at (149.0, 11.4, 23.0)
    ("rib_l_01", "seam_lengthwise"): 75.3,   # at (179.1, -32.0, -0.0)
    ("rib_r_01", "seam_lengthwise"): 75.3,   # at (179.1, 32.0, -0.0)
    ("bay_doors", "former_11"): 72.6,   # at (316.8, -2.6, -27.2)
    ("gear_nose_drag_stay", "seam_lengthwise"): 72.3,   # at (32.8, -0.0, -10.5)
    ...
    ("gear_bay_lining_nose", "longeron_4"): 64.1,   # at (29.7, 5.3, -3.0)
    ("bay_bleed_offtake", "bay_mount_links_fwd"): 63.9,   # at (334.0, 15.2, 13.5)
    ("bay_fire_bottle", "bhd_tail"): 62.2,   # at (382.0, 21.1, 0.5)
    ("antennas", "panel_battery"): 59.4,   # at (252.0, 2.5, 28.0)
    ("gear_nose_chrome_slider", "gear_nose_shimmy_damper"): 58.8,   # at (40.1, -1.6, -25.0)
    ("gear_bay_nose", "longeron_1"): 57.4,   # at (28.0, 5.9, 2.2)
    ("gear_bay_nose", "longeron_2"): 57.4,   # at (28.0, -5.9, 2.2)
    ("bay_fire_loop", "ventral_l"): 56.4,   # at (385.5, -15.2, -11.0)
    ("bay_fire_loop", "ventral_r"): 56.4,   # at (385.5, 15.2, -11.0)
    ("former_12", "rudder_servo"): 55.9,   # at (344.8, -1.2, 23.0)
    ("former_13", "rudder_servo"): 55.3,   # at (371.2, 2.8, 22.8)
    ("former_11", "rudder_servo"): 55.1,   # at (316.8, -0.0, 24.6)
    ("doublers", "vtail_fin"): 53.3,   # at (342.0, 1.3, 25.6)
    ("bl_diverter", "gear_nose_drag_stay"): 52.0,   # at (33.3, 0.3, -11.8)
    ("fin_tip_ecm_fairing", "navlight_tail"): 51.9,   # at (427.7, 0.0, 98.4)
    ("bhd_tail", "seam_lengthwise"): 51.1,   # at (382.0, 23.6, -0.9)
    ("intake_lip", "stringer_09"): 50.2,   # at (60.3, -7.7, -12.6)
    ("intake_lip", "stringer_10"): 50.2,   # at (60.3, 7.7, -12.6)
    ("bay_doors", "stabilator_l"): 45.2,   # at (404.4, -14.7, -17.1)
    ("bay_doors", "stabilator_r"): 45.1,   # at (404.4, 14.7, -17.1)
    ("engine_inlet_case", "wing_seams"): 44.3,   # at (301.6, -16.3, 5.1)
    ("engine_gearbox", "fcs_loom_tail_l"): 42.3,   # at (333.4, -5.9, -22.3)
    ("canopy_glass", "frame_canopy_rear_hinge"): 42.1,   # at (163.6, 3.8, 22.1)
    ("fcs_fcc_envelope", "fcs_loom_trunk_lower_l"): 41.3,   # at (130.9, -7.0, -6.5)
    ("fcs_fcc_envelope", "fcs_loom_trunk_lower_r"): 41.3,   # at (130.9, 7.0, -6.5)
    ("gear_bay_main_l", "seam_ring_06"): 40.6,   # at (252.1, -31.3, -2.3)
    ("gear_bay_main_r", "seam_ring_06"): 40.6,   # at (252.1, 31.3, -2.3)
    ("engine_casing_inlet", "wing_seams"): 39.8,   # at (301.8, -17.0, 5.1)
    ...
    ("control_stick_boots", "rudder_pedals"): 36.1,   # at (110.8, 4.0, 7.1)
    ("gear_bay_nose", "stringer_08"): 35.0,   # at (28.1, -6.0, -4.9)
    ("gear_bay_nose", "stringer_11"): 35.0,   # at (28.1, 6.0, -4.9)
    ("duct_frames", "duct_seam"): 34.1,   # at (275.8, 20.5, -5.2)
    ("fcs_fcc_envelope", "fcs_loom_trunk_upper_l"): 33.8,   # at (129.7, -7.1, -1.1)
    ("fcs_fcc_envelope", "fcs_loom_trunk_upper_r"): 33.7,   # at (130.7, 7.0, -1.4)
    ("antennas", "seam_lengthwise"): 32.9,   # at (249.5, -0.1, 28.7)
    ("gear_main_l", "gear_main_retract_actuator_l"): 32.4,   # at (253.5, -45.9, -23.2)
    ("gear_main_r", "gear_main_retract_actuator_r"): 32.4,   # at (253.4, 45.9, -23.2)
    ("bay_doors", "ventral_l"): 31.2,   # at (376.6, -17.2, -20.5)
    ("bay_doors", "ventral_r"): 31.0,   # at (378.5, 17.3, -20.5)
    ("fuselage_skin", "stab_servo_l"): 30.2,   # at (399.3, -11.1, -20.8)
    ("fuselage_skin", "stab_servo_r"): 30.2,   # at (399.3, 11.1, -20.8)
    ("control_stick_boots", "rudder_pedals_rail"): 29.7,   # at (110.8, 3.3, 7.5)
    ("bay_mount_links_fwd", "engine_fan_door_hardware"): 29.1,   # at (328.8, -13.6, 11.2)
    ("bay_cooling_inlet", "fcs_loom_trunk_lower_l"): 28.9,   # at (299.9, -17.1, 20.0)
    ("bhd_nose", "retract_nose"): 28.8,   # at (65.0, -6.2, -3.6)
    ("bl_diverter", "seam_lengthwise"): 28.8,   # at (40.4, -0.0, -12.5)
    ("canopy_frame", "frame_canopy_seal"): 28.4,   # at (141.1, 13.9, 22.2)
    ("frame_canopy_rear_hinge", "frame_canopy_seal"): 28.1,   # at (164.4, -3.6, 22.0)
    ("bay_fire_bottle", "engine_casing_bypass"): 27.8,   # at (344.1, 16.4, 3.7)
    ("throttle_lever", "throttle_lever_hotas"): 27.5,   # at (112.0, -8.6, 28.5)
    ("antennas", "seam_ring_06"): 26.1,   # at (252.0, -2.1, 28.7)
    ...
    ("cockpit_tub", "frame_canopy_seal"): 23.9,   # at (152.0, -10.3, 21.9)
    ("bay_fire_bottle", "bypass_slots"): 23.6,   # at (343.5, 24.5, 3.7)
    ("bay_bleed_offtake", "engine_flange_inlet"): 23.1,   # at (313.0, 13.5, 11.8)
    ("gear_nose_strut", "seam_ring_01"): 22.7,   # at (42.0, 1.3, -23.4)
    ("fuel_pump", "stringer_01"): 21.9,   # at (154.1, 26.7, 10.3)
    ("bl_diverter", "duct_inlet"): 20.5,   # at (54.0, 0.0, -13.5)
    ("bay_bleed_offtake", "engine_variable_vane_actuation"): 20.0,   # at (320.0, 14.1, 11.8)
    ("gear_bay_hydraulic_lines_nose", "longeron_4"): 19.8,   # at (37.2, 3.7, -3.4)
    ("canopy_windscreen_glass", "seam_lengthwise"): 19.6,   # at (78.2, 0.0, 23.2)
    ("canopy_frame", "frame_canopy_breaker_cord"): 18.6,   # at (134.9, 14.5, 22.9)
    ("canopy_windscreen_glass", "former_03"): 18.6,   # at (88.1, 7.8, 22.3)
    ("naca_inlet_l", "seam_ring_06"): 18.0,   # at (252.0, -29.4, 15.0)
    ("naca_inlet_r", "seam_ring_06"): 18.0,   # at (252.0, 29.4, 15.0)
    ...
    ("bay_bleed_offtake", "engine_fan_containment"): 15.4,   # at (318.5, 13.5, 11.7)
    ("cockpit_tub", "frame_windscreen_bow"): 15.3,   # at (95.9, 11.9, 21.8)
    ("bhd_cockpit", "frame_canopy_seal"): 13.9,   # at (151.0, 11.2, 21.9)
    ("bay_bleed_offtake", "engine_casing_fan"): 13.8,   # at (312.7, 13.5, 11.6)
    ("bay_bleed_offtake", "engine_casing_inlet"): 13.8,   # at (312.7, 13.5, 11.5)
    ("nose_strakes", "seam_ring_03"): 13.0,   # at (98.1, -28.0, 9.9)
    ...
    ("engine_flange_aug_aft", "nozzle_external_flap_06"): 12.7,   # at (423.3, -3.5, -14.0)
    ("engine_flange_aug_aft", "nozzle_external_flap_08"): 12.7,   # at (423.3, -13.0, -4.5)
    ("engine_flange_aug_aft", "nozzle_external_flap_11"): 12.7,   # at (423.3, -3.1, 12.3)
    ("gear_bay_hydraulic_lines_nose", "gear_nose_strut"): 12.7,   # at (39.6, 2.3, -1.3)
    ("engine_flange_aug_aft", "nozzle_external_flap_01"): 12.5,   # at (423.3, 11.2, 6.5)
    ("engine_flange_aug_aft", "nozzle_external_flap_02"): 12.5,   # at (423.3, 12.1, 5.0)
    ("engine_flange_aug_aft", "nozzle_external_flap_04"): 12.5,   # at (423.3, 7.5, -12.2)
    ("engine_flange_aug_aft", "nozzle_external_flap_07"): 12.5,   # at (423.3, -11.2, -8.5)
    ("engine_flange_aug_aft", "nozzle_external_flap_09"): 12.5,   # at (423.3, -12.1, 5.0)
    ("engine_flange_aug_aft", "nozzle_external_flap_10"): 12.5,   # at (423.3, -7.5, 10.2)
    ("fcs_loom_trunk_lower_l", "fcs_loom_trunk_upper_l"): 10.6,   # at (131.7, -8.1, -1.9)
    ("fcs_loom_trunk_lower_r", "fcs_loom_trunk_upper_r"): 10.2,   # at (131.8, 8.1, -1.9)
    ("frame_canopy_seal", "frame_windscreen_bow"): 9.1,   # at (95.8, 11.2, 22.3)
    ("canopy_windscreen_glass", "stringer_03"): 8.9,   # at (95.3, 10.9, 22.3)
    ("canopy_windscreen_glass", "stringer_04"): 8.9,   # at (95.3, -10.9, 22.3)
    ("gear_bay_nose", "gear_door_actuator_nose_l"): 8.3,   # at (36.0, -3.4, 1.7)
    ("gear_bay_nose", "gear_door_actuator_nose_r"): 8.3,   # at (36.0, 3.4, 1.7)
    ("canopy_glass", "frame_canopy_seal"): 8.1,   # at (168.2, 0.4, 22.1)
    ("bay_bleed_offtake", "engine_vbv_doors"): 7.0,   # at (335.9, 14.1, 11.3)
    ...
    ("frame_canopy_seal", "stringer_03"): 6.8,   # at (96.1, 10.8, 22.5)
    ("frame_canopy_seal", "stringer_04"): 6.8,   # at (96.1, -10.8, 22.5)
    ("bhd_tail", "seam_ring_09"): 6.7,   # at (383.0, 0.0, 23.7)
    ("nozzle_external_flap_00", "nozzle_link_00"): 5.9,   # at (426.0, 0.3, 11.4)
    ("nozzle_external_flap_00", "nozzle_link_01"): 5.9,   # at (426.0, 5.9, 9.9)
    ("nozzle_external_flap_01", "nozzle_link_01"): 5.9,   # at (426.0, 6.5, 9.6)
    ("nozzle_external_flap_01", "nozzle_link_02"): 5.9,   # at (426.0, 10.6, 5.5)
    ("nozzle_external_flap_02", "nozzle_link_02"): 5.9,   # at (426.0, 10.9, 4.9)
    ("nozzle_external_flap_02", "nozzle_link_03"): 5.9,   # at (426.0, 12.4, -0.7)
    ("nozzle_external_flap_03", "nozzle_link_03"): 5.9,   # at (426.0, 12.4, -1.3)
    ("nozzle_external_flap_03", "nozzle_link_04"): 5.9,   # at (426.0, 10.9, -6.9)
    ("nozzle_external_flap_04", "nozzle_link_04"): 5.9,   # at (426.0, 10.6, -7.5)
    ("nozzle_external_flap_04", "nozzle_link_05"): 5.9,   # at (426.0, 6.5, -11.6)
    ("nozzle_external_flap_05", "nozzle_link_05"): 5.9,   # at (426.0, 5.9, -11.9)
    ("nozzle_external_flap_05", "nozzle_link_06"): 5.9,   # at (426.0, 0.3, -13.4)
    ("nozzle_external_flap_06", "nozzle_link_06"): 5.9,   # at (426.0, -0.3, -13.4)
    ("nozzle_external_flap_06", "nozzle_link_07"): 5.9,   # at (426.0, -5.9, -11.9)
    ("nozzle_external_flap_07", "nozzle_link_07"): 5.9,   # at (426.0, -6.5, -11.6)
    ("nozzle_external_flap_07", "nozzle_link_08"): 5.9,   # at (426.0, -10.6, -7.5)
    ("nozzle_external_flap_08", "nozzle_link_08"): 5.9,   # at (426.0, -10.9, -6.9)
    ("nozzle_external_flap_08", "nozzle_link_09"): 5.9,   # at (426.0, -12.4, -1.3)
    ("nozzle_external_flap_09", "nozzle_link_09"): 5.9,   # at (426.0, -12.4, -0.7)
    ("nozzle_external_flap_09", "nozzle_link_10"): 5.9,   # at (426.0, -10.9, 4.9)
    ("nozzle_external_flap_10", "nozzle_link_10"): 5.9,   # at (426.0, -10.6, 5.5)
    ("nozzle_external_flap_10", "nozzle_link_11"): 5.9,   # at (426.0, -6.5, 9.6)
    ("nozzle_external_flap_11", "nozzle_link_00"): 5.9,   # at (426.0, -0.3, 11.4)
    ("nozzle_external_flap_11", "nozzle_link_11"): 5.9,   # at (426.0, -5.9, 9.9)
    ("stringer_08", "stringer_09"): 5.6,   # at (112.6, -20.0, -16.0)
    ("stringer_10", "stringer_11"): 5.6,   # at (112.6, 20.0, -16.0)
    ("bay_mount_links_fwd", "engine_blades_fan_r3"): 5.2,   # at (330.3, -12.3, 11.1)
    ("hud_glass_combiner_1", "hud_glass_projector_lens"): 4.9,   # at (105.9, 1.7, 30.4)
    ...
    ("gear_bay_main_l", "gear_door_actuator_main_l"): 4.3,   # at (252.5, -58.0, -2.3)
    ("gear_bay_main_r", "gear_door_actuator_main_r"): 4.3,   # at (252.5, 58.0, -2.3)
    ("canopy_frame", "seam_lengthwise"): 2.4,   # at (78.4, -0.1, 23.0)
    ("leading_edge_flap_l", "wing_l"): 1.7,   # at (292.6, -135.6, -4.7)
    ("leading_edge_flap_r", "wing_r"): 1.7,   # at (292.6, 135.6, -4.7)
}
# --- end KNOWN ---
